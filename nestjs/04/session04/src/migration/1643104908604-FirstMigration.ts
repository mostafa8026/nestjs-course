...
export class FirstMigration1643104908604 implements MigrationInterface {
    name = 'FirstMigration1643104908604'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("id" int NOT NULL IDENTITY(1,1), "title" nvarchar(255) NOT NULL, "content" nvarchar(255) NOT NULL, "location" nvarchar(255) NOT NULL, "likeCount" int NOT NULL CONSTRAINT "DF_ba627db400b27272e68a297a030" DEFAULT 0, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
